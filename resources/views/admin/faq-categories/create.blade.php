...
@section('title', 'Nieuwe Categorie – Admin Panel')
@section('content')
<main style="flex:1; padding:2rem; max-width:600px; margin:auto; background:#FFF7D4; font-family:'Outfit', sans-serif;">
  ...
  <a href="{{ route('admin.faq-categories.index') }}" style="display:inline-block; margin-bottom:1rem; color:#8B0000; text-decoration:none;">
