...
<head>
  <meta charset="UTF-8">
  <title>FAQ Bewerken – Admin Panel</title>
...
<body style="margin:0; font-family:'Outfit',sans-serif; display:flex; height:100vh; background:#FFF7D4;">
  ...
  <main style="flex:1; padding:2rem; overflow-y:auto;">
    <h1 style="color:#8B0000;">Vraag bewerken</h1>

    <form method="POST" action="{{ route('admin.faq.update', $faq) }}" style="max-width:600px; margin-top:1rem;">
      @csrf @method('PUT')
      ...
      <div style="margin-bottom:1rem;">
        ...
        <input type="text" name="question" id="question" value="{{ old('question',$faq->question) }}" required style="width:100%; padding:.5rem; border:1px solid #ccc; border-radius:4px;">
      ...
      <div style="margin-bottom:1rem;">
        ...
        <textarea name="answer" id="answer" rows="4" style="width:100%; padding:.5rem; border:1px solid #ccc; border-radius:4px;">{{ old('answer',$faq->answer) }}</textarea>
